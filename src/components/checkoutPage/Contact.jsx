...
export const Contact = ()=>{
    return(
        <section className="flex">
            <div className="px-[77px] py-10 bg-[#FFF6ED]">
                <form  className="w-[500px] space-y-6">
                    <div className="space-y-6">
                        <label htmlFor="email" className="text-[20px] font-[500] text-[#302E2E]">Contact</label>
                        <div className="space-y-2">
                            <input type="text" id="email" placeholder="Email" className="w-[500px] h-[50px] outline-none bg-[#FFFFFF] py-[10px] px-[20px] border border-[0.3px] border-[#A8A4A4] rounded-[5px]"/>
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="space-y-4">
                            <div>
                                <div className="flex items-center justify-between py-[10px] px-[20px] border border-[0.3px] border-[#A8A4A4] bg-[transparent] rounded-tl-[5px] rounded-tr-[5px] h-[50px] w-[500px]">
                                ...
                                <div className="flex items-center justify-between py-[10px] px-[20px] border-x border-x-[0.3px] border-x-[#A8A4A4] border-b border-b-[0.3px] border-b-[#A8A4A4] bg-[#FFFFFF] rounded-bl-[5px] rounded-br-[5px] h-[50px] w-[500px]">
                                    <div className="flex gap-[10px]">
                                        <input type="radio" name="delivery" />
                            ...
                            <div className="py-[10px] px-[20px] border border-[0.3px] border-[#A8A4A4] bg-[#FFFFFF] rounded-[5px] h-[50px] w-[500px]">
                                <input type="text" placeholder="Location" className="w-full h-full outline-none" />
                            </div>
                            <div className="flex justify-between">
                                <div className="py-[10px] px-[20px] border border-[0.3px] border-[#A8A4A4] bg-[#FFFFFF] rounded-[5px] h-[50px] w-[245px]">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="py-[10px] px-[20px] border border-[0.3px] border-[#A8A4A4] bg-[transparent] rounded-[5px] h-[50px] w-[500px] flex justify-between items-center">
                    ...
                    <button className="py-[10px] px-[20px] border border-[0.3px] border-[#A8A4A4] bg-[#611750] hover:bg-[#61175090] text-center text-[white] rounded-[6px] h-[50px] w-[500px] font-[500]">Pay Now</button>
                </form>
            </div>

            <div className="pr-[77px] pl-[20px] space-y-10">
                ...
                <div className="space-y-6">
                    <div className="flex justify-between">
                        <input type="text" id="email" placeholder="Email" className="w-[410px] h-[50px] outline-none bg-[#FFFFFF] py-[10px] px-[20px] border border-[0.3px] border-[#A8A4A4] rounded-[5px]"/>
