                ...
                <div className="space-y-10">
                    ...
                    <div className="space-y-8">
                        <div className="space-y-4">
                            <h2 className="text-[36px] text-[#4A4949] leading-[34px] font-[500] max-[500px]:text-[25px] max-[306px]:text-[20px] max-[306px]:leading-[23px]">Hydroquinone Cream USP 30g Sol de Janeiro Cheirosa ’71</h2>
                            <p className="text-[#4A4949] leading-[24px] max-[306px]:text-[14px] max-[306px]:leading-[15px]">Experience a luxurious warmth with this inviting scent that’s like a cashmere comforter for your nose.</p>
                        ...
                        <div className="space-y-4">
                            <div className="bg-[#611750] w-full py-[4px] px-[8px] flex items-center gap-10 max-[384px]:gap-0 max-[384px]:justify-between rounded-[3px]">
                                <div className="bg-[#FFFFFF] flex gap-4 items-center py-[8px] px-[6px] max-[384px]:py-[4px] max-[384px]:gap-[2px]">
                                    <button className="hover:bg-[#A8A4A490] rounded-[50%] w-6 h-6 max-[384px]:text-[14px]">-</button>
                                    <span>1</span>
                                    <button className="hover:bg-[#A8A4A490] rounded-[50%] w-6 h-6 max-[384px]:text-[14px]">+</button>
                                </div>
                                <div tabIndex={0} className="flex cursor-pointer items-center gap-4">
                                    ...
                                    <p className="text-[#FFFFFF] font-bold max-[384px]:text-[14px]"># 10,000</p>
                                </div>
                            </div>
