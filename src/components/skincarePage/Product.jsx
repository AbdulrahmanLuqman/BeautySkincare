...
//     useEffect(()=>{
//         fetch("https://timbu-get-all-products.reavdev.workers.dev/?organization_id=09d3fa1d7caf45198c7d57ac510b4860&reverse_sort=false&page=1&size=22&Appid=M11P68UGQP6B9Q4&Apikey=8104ad78708a4e6680c4201aa3378d2320240713160836808258")
//         .then(res => res.json())
...
//     }, [])
    ...
    const currentProduct = productsData.slice(startIndex, endIndex)
    ...
    return(
        <section className="px-[77px] py-[70px] max-[1170px]:px-[40px]">
                    ...
                    currentProduct.map((product) => (
                        <div key={product.index} className="w-full cursor-pointer h-[426px] bg-[#FFFFFF] shadow-lg shadow-gray-500/40 rounded-[10px] py-6 px-4 relative flex flex-col justify-between items-center">
                            ...
                            <div className="flex justify-between items-center w-full">
                                ...
                                <p className="text-[17px] text-[#1E1E1E] font-[600]"><span>#</span>{product.price}</p>
            ...
            <div className="w-[100px] mx-auto flex items-center justify-between">
                ...
                <button className="border rounded-[50%] p-2 bg-[#FFC3BB]" disabled={endIndex >= productsData.length} onClick={next}><FaArrowRight/></button>
            </div>
        </section>
    )
}